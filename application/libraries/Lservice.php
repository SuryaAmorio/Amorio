...
class Lservice {
    ...
    public function help_list() {
        ...
        $serviceList = $CI->parser->parse('help_desk/list', $data, true);
       ...
       public function help_desk_show() {
        ...
        $serviceList = $CI->parser->parse('help_desk/show', $data, true);
    ...
    public function content_add_form() {
        ...
        $serviceForm = $CI->parser->parse('help_desk/add_content_form', $data, true);
