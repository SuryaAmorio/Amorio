...
if($query)
{
    ...
    {
        //////////////////////SAles
        if($_REQUEST['form_type']=='sales&Profarma')
        {
          ...
          $this->db->where('invoice_template',$_REQUEST['form_type']);
 ...
 echo $sql = "UPDATE `sales_invoice_settings` SET `account` = '".$_REQUEST['acc']."',`address`='".$_REQUEST['company_address']."' WHERE `sales_invoice_settings`.`id` =".$id;
$query=$this->db->query($sql);
    }
    else
    {
   
          $sql = "insert into sales_invoice_settings(invoice_template,user_id,account,address) VALUES('".$_REQUEST['form_type']."','".$_SESSION['user_id']."','".$_REQUEST['acc']."','".$_REQUEST['company_address']."')";
$query=$this->db->query($sql);
...
$sql = "UPDATE `sales_invoice_settings` SET `remarks` = '".$_REQUEST['remarks']."' WHERE `sales_invoice_settings`.`id` =".$id;
$query=$this->db->query($sql);
    }
    else
    {
   
         $sql = "insert into sales_invoice_settings(user_id,remarks,invoice_template) VALUES('".$_SESSION['user_id']."','".$_REQUEST['remarks']."','".$_REQUEST['form_type']."') ";
$query=$this->db->query($sql);
        ...
        <script type="text/javascript">
            alert('Updated');
            location.href='invoice_template';
        </script>
        <?php
}
