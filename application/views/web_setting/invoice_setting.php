        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('Cweb_setting/updateinvoice', array('class' => 'form-vertical', 'id' => '')) ?>
                    <div class="panel-body">

                         <input name ="form_type" type="hidden" value="new_sale">

                         

                        <div class="form-group row">
                            <label for="logo" class="col-sm-3 col-form-label">Account details<i class="text-danger">*</i></label>
                            <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('Cweb_setting/updateinvoice', array('class' => 'form-vertical', 'id' => 'insert_customer')) ?>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            <label for="invoice_logo" class="col-sm-3 col-form-label">Remarks<i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <textarea required class="form-control" rows="4" cols="50" name ="remarks" id="company_address" type="text" tabindex="2"></textarea>
                            </div>
                        </div>
            ...
            <div class="col-sm-12">
                ...
                <div class="panel-body">
                       ...
                       <div class="form-group row">
                            <label for="invoice_logo" class="col-sm-3 col-form-label">Remarks<i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <textarea class="form-control" rows="4" required cols="50" name ="remarks" required id="company_address" type="text" tabindex="2"></textarea>
                            </div>
                        </div>
                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                         ...
                         <div class="form-group row">
                            <label for="invoice_logo" class="col-sm-3 col-form-label">Remarks<i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <textarea class="form-control" required rows="4" cols="50" name ="remarks" id="company_address" type="text" tabindex="2"></textarea>
                            </div>
                        </div>
