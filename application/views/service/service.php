...
<?php if($this->permission1->method('manage_service_invoice','read')->access()){ ?>
                    ...
                    <a href="<?php echo base_url('Cservice/manage_service_invoice') ?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-plus"> </i> Manage service Invoice </a>
...
<?php if($this->permission1->method('service_invoice','create')->access()){ ?>
                    ...
                    <a href="<?php echo base_url('Cservice/service_invoice_form') ?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-plus"> </i>Service Invoice Form</a>
