...
function quantity_calculate(item) {
    ...
    if (parseInt(quantity) > parseInt(available_quantity)) {
        //alert(quantity+'_'+available_quantity);
       // alert("#available_quantity_" + item);
